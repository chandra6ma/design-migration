...
{
    [Guid("ec73b316-e26a-4e37-ae8e-b6221646d182")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": TranslatorPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": TranslatorPlugin: deactivating... ");
